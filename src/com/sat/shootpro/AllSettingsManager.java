...
/**
 * @author stas.savinov
 * @Name AllSettingsManager
 * @description Class wrapper between memory and activity.
 * All that must be get/set for/from the memory - must be set here.  
...
{
   private String LOG = "AllSettingsManager";
    ...
    * @return 
    * ***********************************************************************/
   public AllSettingsManager(Context ctx)
   {
      if (ctx == null)
      {
     ...
     * ***********************************************************************/
     ...
     public void getInitAtmospereParams()
     {
        if(null != StartMenuActivity.Engine)
        {
           ...
           {
              /*--------------------------------------------------------------*/
              setPrefParameters(SAVE_PARAMS_STRUCTURE.ALTITUDE,1.0);
              /*--------------------------------------------------------------*/
              setPrefParameters(SAVE_PARAMS_STRUCTURE.LATITUDE, 49.9935000);
              /*--------------------------------------------------------------*/
              setPrefParameters(SAVE_PARAMS_STRUCTURE.AZIMUT, init);
              /*--------------------------------------------------------------*/
              setPrefParameters(SAVE_PARAMS_STRUCTURE.TEMPERATURE, 15.0);
              /*--------------------------------------------------------------*/
              setPrefParameters(SAVE_PARAMS_STRUCTURE.IS_CELSIUM, true);
              /*--------------------------------------------------------------*/
              setPrefParameters(SAVE_PARAMS_STRUCTURE.DENSITY,init);
              /*--------------------------------------------------------------*/
              setPrefParameters(SAVE_PARAMS_STRUCTURE.PRESSURE, init);
              /*--------------------------------------------------------------*/
              setPrefParameters(SAVE_PARAMS_STRUCTURE.HUMIDITY, 50.0);
              /*--------------------------------------------------------------*/
              setPrefParameters(SAVE_PARAMS_STRUCTURE.SOUND_SPEED, 340.29);
              /*--------------------------------------------------------------*/
              setPrefParameters(SAVE_PARAMS_STRUCTURE.GRAVIRY, 9.8);
              /*--------------------------------------------------------------*/
           }
           setWindParameters();
        }
   ...
   /**************************************************************************
    * Function: getSoundFlagSettings
    * @param  None.
    * @return {@link Boolean} bRet.
    * ***********************************************************************/
